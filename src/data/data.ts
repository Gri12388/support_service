...
export const messages: t.Imessages = {
  ...
  noMatch: 'There is no match at find function',
  noRole: 'Role is not defined',
  noOffset: 'Offset is not received',
  noSlug: 'There is no slug property',
  noStatuses: 'Statuses are not recieved',
  noTitle: 'There is no title of claim',
  noToken: 'Token is not recieved',
  noTypes: 'Types are not recieved',
