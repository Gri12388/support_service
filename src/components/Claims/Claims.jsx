...
function Claims() {
  ...
  // token и после его получения загружаем данные. Если token
  // не просрочен, загружаем данные.                                    
  //------------------------------------------------------------//
  useEffect(() => {
    if (!token && !keepLogged) {
      navigate('/');
  ...
  //------------------------------------------------------------//
  // Если token просрочен и нет нужды автоматически получать
  // новый token выходим из функции.                                   
  //------------------------------------------------------------//
